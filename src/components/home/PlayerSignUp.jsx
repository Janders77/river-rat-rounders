  ...
  if (!expanded) {
    return (
      <button
        ...
        className="w-full flex items-center gap-4 p-5 rounded-xl border border-emerald-600/40 bg-gradient-to-r from-emerald-600/20 to-emerald-700/10 hover:border-emerald-500/70 transition-all duration-200 group"
      >
