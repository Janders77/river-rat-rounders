        ...
        <div className="max-w-lg w-full">
          ...
          <div className="space-y-6">
            ...
            <Link
              ...
              className="flex items-center gap-4 p-5 rounded-xl border border-green-500/25 hover:border-green-400/50 bg-gradient-to-br from-green-500/20 to-green-700/13 hover:from-green-500/30 hover:to-green-700/20 transition-all duration-200 group"
            >
